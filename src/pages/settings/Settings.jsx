        ...
        <div className="settings" >
            <div className="settingsWrapper">
                ...
                <form className="settingsForm">
                    ...
                    <input className="settingsPPInput" type="text" placeholder='Usoroh' />

                    <label>Email</label>
                    <input className="settingsPPInput" type="email" placeholder='ghostcybertron@gmail.com' /> 
                    
                    <label>Password</label>
                    <input className="settingsPPInput" type="password" />
